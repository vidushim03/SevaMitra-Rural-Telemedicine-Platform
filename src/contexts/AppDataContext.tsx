...
const seedUsers: SessionUser[] = [
  ...
  { id: 'doctor_1', name: 'Dr. Priya Sharma', role: 'doctor', email: 'priya@demo.com', specialty: 'General Physician', consultationFee: 50 },
  { id: 'doctor_2', name: 'Dr. Rajesh Kumar', role: 'doctor', email: 'rajesh@demo.com', specialty: 'Cardiologist', consultationFee: 200 },
  { id: 'doctor_3', name: 'Dr. Meena Iyer', role: 'doctor', email: 'meena@demo.com', specialty: 'Dermatologist', consultationFee: 100 },
  { id: 'doctor_4', name: 'Dr. Arjun Patel', role: 'doctor', email: 'arjun@demo.com', specialty: 'Pediatrician', consultationFee: 100 },
  { id: 'doctor_5', name: 'Dr. Sunita Rao', role: 'doctor', email: 'sunita@demo.com', specialty: 'Gynecologist', consultationFee: 150 },
  // Admin
  ...
  payments: [
    {
      ...
      amount: 58,
      lineItems: [
        { description: 'Consultation - General Physician', quantity: 1, unitPrice: 50, total: 50 },
        { description: 'Paracetamol 500mg (1 strip)', quantity: 1, unitPrice: 4, total: 4 },
        { description: 'Cetirizine 10mg (1 strip)', quantity: 1, unitPrice: 3, total: 3 },
      ],
      status: 'pending',
      method: 'cash',
