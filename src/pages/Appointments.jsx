...
export const Appointments = () => {
  const { data, doctors, patients, addAppointment, updateAppointmentStatus } =
    useAppData();
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <button className="rounded-lg bg-blue-600 text-white px-6 py-2 font-medium">
          {t.book}
        </button>
      </form>
              ...
              <tr key={a.id} className="border-t">
                ...
                <td className="p-3 flex gap-2">
                  {(user.role === "doctor" || user.role === "admin") && (
                    <>
                      <button
                        ...
                        className="px-2 py-1 rounded bg-amber-100 dark:bg-amber-900/40"
                      >
                        {t.start}
                      </button>
                      <button
                        ...
                        className="px-2 py-1 rounded bg-emerald-100 dark:bg-emerald-900/40"
                      >
                        {t.complete}
                      </button>
                    </>
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded bg-rose-100 dark:bg-rose-900/40"
                  >
                    {t.cancel}
                  </button>
                </td>
