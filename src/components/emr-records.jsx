...
export function EMRRecords({ language }) {
  ...
  const getMedicalRecords = () => [
    {
      ...
      prescription: [
        {
          medicine: t.paracetamol,
          dosage: "500mg",
          frequency: t.thriceDaily,
          duration: t.fiveDays,
        },
        {
          medicine: t.coughSyrup,
          dosage: "10ml",
          frequency: t.thriceDaily,
    ...
    },
    {
      ...
      prescription: [
        {
          medicine: t.amlodipine,
          dosage: "5mg",
          frequency: t.onceDaily,
          duration: t.thirtyDays,
        },
      ],
            ...
            {selectedRecord ? (
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">{t.clickRecordToView}</p>
                </CardContent>
              </Card>
            )}
          </div>
