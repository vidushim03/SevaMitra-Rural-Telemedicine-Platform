...
export function SymptomChecker({ language, onPageChange }) {
      ...
      symptoms: [
        {
          ...
          icon: Thermometer,
          color:
            "bg-red-100 border-red-200 hover:bg-red-200 dark:bg-red-900/30 dark:border-red-800 dark:hover:bg-red-900/50",
        },
        {
          id: "cough",
          label: t.cough,
          icon: Zap,
          color:
            "bg-orange-100 border-orange-200 hover:bg-orange-200 dark:bg-orange-900/30 dark:border-orange-800 dark:hover:bg-orange-900/50",
        },
        {
          id: "breathing",
          label: t.breathingIssues,
          icon: Heart,
          color:
            "bg-blue-100 border-blue-200 hover:bg-blue-200 dark:bg-blue-900/30 dark:border-blue-800 dark:hover:bg-blue-900/50",
        },
      ],
    },
    neurological: {
      ...
      symptoms: [
        {
          ...
          icon: Zap,
          color:
            "bg-purple-100 border-purple-200 hover:bg-purple-200 dark:bg-purple-900/30 dark:border-purple-800 dark:hover:bg-purple-900/50",
        },
      ],
    },
    gastrointestinal: {
      ...
      symptoms: [
        {
          ...
          icon: AlertTriangle,
          color:
            "bg-yellow-100 border-yellow-200 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:border-yellow-800 dark:hover:bg-yellow-900/50",
        },
      ],
    },
    cardiovascular: {
  ...
  const handleSymptomToggle = (symptomId) => {
    ...
    if (symptom) {
      ...
      const symptomLabels = allSelected
        .map(
          (id) =>
  ...
  const analyzeSymptoms = async () => {
    ...
    setTimeout(() => {
      ...
      const mockResults = {
        ...
        possibleConditions: [
          {
            name: aiRes.specialist + ` ${t.consult}`,
            probability: Math.round(aiRes.likelihood * 100),
            description: aiRes.reasoning,
          },
          {
            name: t.commonCold,
            probability: 75,
            description: t.commonColdDesc,
          },
  ...
  const shareResults = () => {
    if (navigator.share) {
      ...
      navigator.clipboard
        .writeText(`Health Analysis: ${results?.urgencyLevel} - ${symptoms}`)
      ...
      <div className="flex items-center mb-3">
        ...
        <div>
          <h3 className="font-bold text-lg">
            {t.emergencyDetected || "Emergency Detected!"}
          </h3>
          <p className="text-sm">
            {t.callEmergencyNow || "Call emergency services now!"}
          </p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-600">
            {t.basedOnMedicalDatabase || "Based on medical database:"}{" "}
            {results?.dataPointsUsed}{" "}
            {t.medicalReferences || "medical references"}
          </p>
        </div>
      </div>
    );
          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="space-y-2">
              <div className="text-sm text-gray-500">
                🧠 {t.processingMedicalKnowledge}
              </div>
              <div className="text-sm text-gray-500">
                🔍 {t.analyzingSymptomPatterns}
              </div>
              <div className="text-sm text-gray-500">
                📊 {t.calculatingRiskAssessment}
              </div>
            </div>
  ...
  const stepText =
    t.stepOf
      ...
      .replace("{total}", "4") || `Step ${currentStep} of 4`;
            ...
            <div className="space-y-8">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-blue-800">
                      <p className="font-medium mb-1">{t.toUseVoiceInput}</p>
                      <p className="text-xs">{t.voiceInputHelp}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-500">
                  💡{" "}
                  {t.selectOrDescribeHelp ||
                    "Select symptoms above or describe them in detail below"}
                </p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">{t.selectDurationOfSymptoms}</p>
              </div>
              ...
              >
                ...
                <div className="flex items-center space-x-4 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-300 transition-colors cursor-pointer">
                  ...
                  <Label
                    htmlFor="more-than-week"
                    className="flex-1 cursor-pointer text-lg"
                  >
                    <div>
                      <div className="font-semibold">{t.moreThanWeek}</div>
                      <div className="text-sm text-gray-600">
                        {t.extendedDurationSymptoms}
                      </div>
                    </div>
                  </Label>
                </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">{t.rateSeverityOfSymptoms}</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSeveritySliderValue(parseInt(e.target.value))
                    }
          ...
          {currentStep === 4 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">{t.howUrgentCondition}</p>
              </div>
              ...
              >
                ...
                <div className="flex items-center space-x-4 p-4 border-2 border-gray-200 rounded-xl hover:border-yellow-300 transition-colors cursor-pointer">
                  ...
                  >
                    <div>
                      <div className="font-semibold text-yellow-700">
                        {t.shouldSeeDoctor1to2Days ||
                          "Should see doctor in 1-2 days"}
                      </div>
                      <div className="text-sm text-gray-600">
                        {t.moderatelyUrgent}
                      </div>
                ...
                <div className="flex items-center space-x-4 p-4 border-2 border-gray-200 rounded-xl hover:border-red-300 transition-colors cursor-pointer">
                  ...
                  >
                    <div>
                      <div className="font-semibold text-red-700">
                        {t.needImmediateMedicalAttention ||
                          "Need immediate medical attention"}
                      </div>
                      <div className="text-sm text-gray-600">
                        {t.urgentEmergencyCare}
                      </div>
                    </div>
                  </Label>
                </div>
