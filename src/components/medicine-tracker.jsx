...
export function MedicineTracker({ language }) {
  ...
  const markDoseTaken = (medicineId, scheduledTime) => {
  ...
  const calculateCompliance = (medicine) => {
    const totalExpected = medicine.takenDoses + medicine.missedDoses;
    return totalExpected > 0
      ? Math.round((medicine.takenDoses / totalExpected) * 100)
      : 0;
  };
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-sm text-muted-foreground">
                              <span>
                                {t.taken}: {medicine.takenDoses}/
                                {medicine.totalDoses}
                              </span>
                              <span>
                                {t.missed}: {medicine.missedDoses}
                              </span>
                            </div>
                          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1">
                      {selectedMedicine.timings.map((time, index) => (
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <Progress
                        value={calculateCompliance(selectedMedicine)}
                        className="h-3"
                      />
                      <div className="flex justify-between text-sm mt-1">
                        <span>
                          {t.taken}: {selectedMedicine.takenDoses}
                        </span>
                        <span>
                          {t.missed}: {selectedMedicine.missedDoses}
                        </span>
                      </div>
                    </div>
                  </div>
