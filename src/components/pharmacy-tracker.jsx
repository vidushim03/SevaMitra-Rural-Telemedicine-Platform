...
export function PharmacyTracker({ language }) {
  ...
  const [medicines, setMedicines] = useState([
    {
      ...
      stocks: {
        1: {
          quantity: 150,
          status: "in_stock",
          lastUpdated: "2024-01-25 10:30",
        },
        2: {
          quantity: 25,
          status: "low_stock",
          lastUpdated: "2024-01-25 09:45",
        },
        3: {
          quantity: 0,
          status: "out_of_stock",
          lastUpdated: "2024-01-24 18:00",
        },
        4: {
          quantity: 80,
          status: "in_stock",
          lastUpdated: "2024-01-25 11:15",
        },
        5: {
          quantity: 40,
          status: "in_stock",
          lastUpdated: "2024-01-25 10:45",
        },
        6: {
          quantity: 15,
          status: "low_stock",
          lastUpdated: "2024-01-25 09:30",
        },
      },
    },
    {
      ...
      stocks: {
        1: {
          quantity: 80,
          status: "in_stock",
          lastUpdated: "2024-01-25 11:00",
        },
        2: {
          quantity: 5,
          status: "low_stock",
          lastUpdated: "2024-01-25 10:15",
        },
        3: {
          quantity: 20,
          status: "in_stock",
          lastUpdated: "2024-01-25 08:30",
        },
        4: {
          quantity: 60,
          status: "in_stock",
        ...
        5: {
          quantity: 10,
          status: "low_stock",
          lastUpdated: "2024-01-25 11:30",
        },
        6: {
          quantity: 35,
          status: "in_stock",
          lastUpdated: "2024-01-25 10:00",
        },
      },
    },
    {
      ...
      stocks: {
        ...
        3: {
          quantity: 10,
          status: "low_stock",
          lastUpdated: "2024-01-25 07:45",
        },
        4: {
          quantity: 120,
          status: "in_stock",
          lastUpdated: "2024-01-25 11:45",
        },
        5: {
          quantity: 25,
          status: "low_stock",
    ...
    },
    {
      ...
      stocks: {
        ...
        5: {
          quantity: 3,
          status: "low_stock",
          lastUpdated: "2024-01-25 07:00",
        },
        6: {
          quantity: 0,
          status: "out_of_stock",
          lastUpdated: "2024-01-24 20:00",
        },
      },
    },
  ]);
      ...
      (error) => {
        ...
        switch (error.code) {
          ...
          case error.TIMEOUT:
            errorMessage =
              language === "hi"
                ? "स्थान प्राप्त करने में समय समाप्त"
                : language === "pa"
                  ? "ਸਥਾਨ ਪ੍ਰਾਪਤ ਕਰਨ ਵਿੱਚ ਸਮਾਂ ਸਮਾਪਤ"
        ...
        setNearbyPharmacies(
          mockPharmaciesData.map((pharmacy) => ({
            ...pharmacy,
  ...
  const findNearbyPharmacies = (location) => {
    const pharmaciesWithDistance = mockPharmaciesData.map((pharmacy) => {
      ...
      return {
        ...
        lastUpdated:
          distance < 1 ? "Just now" : `${Math.round(distance * 2)} mins ago`,
      };
    });
  ...
  const updateStock = (medicineId, pharmacyId, newQuantity) => {
  ...
  const PharmacistStockUpdate = ({ medicine }) => {
    const [newQuantity, setNewQuantity] = useState(
      selectedPharmacy
        ? medicine.stocks[selectedPharmacy.id]?.quantity || 0
        : 0,
    );
      ...
      <Card className="border-2">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge
              className={getStatusColor(
                medicine.stocks[selectedPharmacy?.id]?.status || "out_of_stock",
              )}
            >
              {getStatusText(
                medicine.stocks[selectedPharmacy?.id]?.status || "out_of_stock",
          ...
          <Button
            size="sm"
            onClick={() =>
              updateStock(medicine.id, selectedPharmacy?.id, newQuantity)
            }
            className="w-full"
          >
            {t.updateStock}
      ...
      <div className="max-w-7xl mx-auto">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  {userLocation && (
                    <Select
                      value={sortBy}
                      onValueChange={(value) => sortPharmacies(value)}
                    >
                ...
                {userLocation && (
                  <p className="text-xs text-muted-foreground">
                    ...
                    {t.pharmaciesFound || "pharmacies found"}
                  </p>
                )}
              </CardHeader>
                  ...
                  >
                    <CardContent className="p-3">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <Badge
                          variant={pharmacy.isOpen ? "secondary" : "outline"}
                        >
                          {pharmacy.isOpen
                            ? t.open || "Open"
                            : t.closed || "Closed"}
                ...
                {isPharmacistView ? (
                  <div>
                    <Card className="mb-6">
                      <CardHeader>
                        <CardTitle>
                          Pharmacist Dashboard - {selectedPharmacy.name}
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between mb-3">
                              ...
                              <div className="text-right">
                                ...
                                <Badge
                                  className={`gap-1 ${getStatusColor(stock?.status || "out_of_stock")}`}
                                >
                                  {getStatusIcon(
                              ...
                              <div className="space-y-2">
                                ...
                                {stock.status === "in_stock" && (
                                  <Button
                                    ...
                                    onClick={() =>
                                      callPharmacy(selectedPharmacy.phone)
                                    }
                                  >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-muted-foreground">
            ...
            {userLocation &&
              ` • ${t.location || "Location"}: ${userLocation.latitude.toFixed(4)}, ${userLocation.longitude.toFixed(4)}`}
          </p>
        </div>
      </div>
    </div>
